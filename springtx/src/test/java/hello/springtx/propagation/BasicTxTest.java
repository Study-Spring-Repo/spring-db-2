...
class BasicTxTest {
    ...
    void inner_commit() {
        ...
        log.info("outer.isNewTransaction()={}", Optional.of(outer.isNewTransaction()));

        log.info("내부 트랜잭션 시작");
        final TransactionStatus inner = txManager.getTransaction(new DefaultTransactionDefinition());
        log.info("inner.isNewTransaction()={}", Optional.of(inner.isNewTransaction()));
        log.info("내부 트랜잭션 커밋");
    ...
    void inner_rollback_requires_new() {
        log.info("외부 트랜잭션 시작");
        final TransactionStatus outer = txManager.getTransaction(new DefaultTransactionDefinition());
        log.info("outer.isNewTransaction()={}", Optional.of(outer.isNewTransaction())); // true
        ...
        log.info("inner.isNewTransaction()={}", Optional.of(inner.isNewTransaction())); // true
